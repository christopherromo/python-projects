...
def format_matrix(the_array: numpy.array) -> numpy.array:
    ...
    Args:
        the_array (numpy.array): A 3xN array where each column represents a point (x, y, 1).
    ...
    formatted_matrix = numpy.array([[a1,a4,a5,a3,a2],[b1,b4,b5,b3,b2],[1,1,1,1,1]])
...
def draw_a(the_array: numpy.array) -> None:
    """
    Draws the letter 'A' based on the provided 2D array of points with columns formatted in the order: 1, 4, 5, 3, 2.
...
def main() -> None:
    ...
    graphic_composite_output.write('Here are the matrices used to make the transformations:')
    ...
    for num in order:
        match num:
            ...
            case '1':
                ...
                move_to_origin_matrix = numpy.array([[1,0,(point_x * -1)],[0,1,(point_y * -1)],[0,0,1]])
                move_back_from_origin_matrix = numpy.array([[1,0,point_x],[0,1,point_y],[0,0,1]])
                rotation_matrix = numpy.array([[math.cos(rotation),(math.sin(rotation) * -1),0],[math.sin(rotation),math.cos(rotation),0],[0,0,1]])
                ...
                # add matrices to composite file and multiply with composite matrix
            ...
            case '2':
                ...
                # add matrix to composite file and multiply with composite matrix
                graphic_composite_output.write('\n\nShearing Matrix:\n')
